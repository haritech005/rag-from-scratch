...
import { ExtractedDocument, ChunkedDocument } from "@/types";

/**
 * Local JSON Storage Utilities for Phase 1 & Phase 2
 * 
 * - Saves extracted pages into `data/extracted_pages.json`
 * - Saves text chunks into `data/chunks.json`
 */
